...
DeepSeek++ enhances the DeepSeek web app with persistent memory, reusable skills, built-in web search and page fetch tools, system prompt presets, MCP tool execution, and scheduled automation.
...
DeepSeek++ 为 DeepSeek 网页版增加长期记忆、Skill 技能、内置网络搜索和网页获取工具、系统提示词预设、MCP 工具调用和自动化任务。
